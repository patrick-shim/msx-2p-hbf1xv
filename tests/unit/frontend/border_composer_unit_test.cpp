...
//
// M39-B re-confirmation (openMSX 19.1 Sony_HB-F1XV, screenshot -raw): 192-line
// active top row = 24 (the scroll-shooter SCREEN 1 loader, R#9 LN=0), 212-line active top
// row = 14 (the scroll-shooter GRAPHIC4 gameplay, R#9 LN=1) -- the 10-line difference
// matches openMSX VDP.cc:474-483 lineZero (top border +10 lines when LN=0), so
// the y0 anchors below (24@192, 14@212) are the exact openMSX geometry for both
// modes. This is the frame-geometry oracle for the M39-B default-present fix.
