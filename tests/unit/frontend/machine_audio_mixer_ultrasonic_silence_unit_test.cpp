...
//
// THE ULTRASONIC-SILENCE ORACLE: the scroll-shooter silence idiom (tone period 0
...
// three channels -- the DEC-0043-measured scroll-shooter register idiom generalized
// over p.
