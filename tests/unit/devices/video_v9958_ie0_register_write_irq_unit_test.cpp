...
// VBlank/line-match and the S#0/S#1 status reads. This is the fix for the
// multi-disk RPG title's
...
int main() {
    // ------------------------------------------------------------------------
    // Case group 1: the exact RPG-title scenario -- IE0 cleared by an R#1 write
