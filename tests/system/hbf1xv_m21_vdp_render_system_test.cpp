...
// Suite: System_Hbf1xvM21VdpRender_System
//
...
int main() {
    ...
    // --- YJK family: SCREEN12 (GRAPHIC7 base + R#25 YJK). ---
    {
        ...
        // pixel0 y=1->(1,1,1); pixel1 y=2->(2,2,3); pixel2 y=4->(4,4,5);
        // pixel3 y=0->(0,0,0) via PLAIN truncating division (A-M21-5).
        expect(fb.at(0, 0) == sony_msx::devices::video::pack_rgb555(1, 1, 1), "Yjk_Golden_Pixel0");
        expect(fb.at(1, 0) == sony_msx::devices::video::pack_rgb555(2, 2, 3), "Yjk_Golden_Pixel1");
        expect(fb.at(2, 0) == sony_msx::devices::video::pack_rgb555(4, 4, 5), "Yjk_Golden_Pixel2");
        expect(fb.at(3, 0) == sony_msx::devices::video::pack_rgb555(0, 0, 0), "Yjk_Golden_Pixel3_TruncatingDivision");
    }
