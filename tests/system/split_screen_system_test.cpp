...
// Suite: System_Hbf1xvSplitScreen_System (M32-S3, Defect A of DEC-0039,
// docs/m32-planner-package.md §2.6 / test matrix row 7)
//
// THE SCROLL-SHOOTER-SHAPE UNIVERSAL ORACLE, with zero game assets and zero game
...
int main(int argc, char** argv) {
    // Optional evidence-dump mode for tools/openmsx/split-screen-ab.ps1 (side
    ...
    std::cout << "All System_Hbf1xvSplitScreen_System cases passed\n";
    return 0;
}
