...
// Suite: Hbf1xv_M36SnapshotDeterminism_System (M36 Phase 3 slice S5, the
// headline determinism gate, DEC-0051 point 5 / AC-6).
//
...
// boundary -- an authentic "the run went further" perturbation, the deterministic
// proxy for the planner's "one extra scripted keypress") MUST produce a DIFFERENT
...
int main() {
    ...
    std::cout << "All Hbf1xv_M36SnapshotDeterminism_System cases passed\n";
    return 0;
}
