...
// Suite: Machine_Hbf1xvM34ScrollShooterUltrasonic_System (M34-S3, DEC-0043 Defect
// A, docs/m34-planner-package.md §2.6.4 / test matrix row 10)
//
// THE SCROLL-SHOOTER TRANSITION REGRESSION (a scrolling-shooter title): the
// human-reported v1.0.33/v1.0.34
...
// shape): real BIOS cold boot, roms/scroll-shooter.rom loaded EXPLICITLY as
...
// 600/1500/2100/2700 (cycle stamps (f-1)*59736 -- the exact stamp
// convention of the M19 evidence-capture input script in tools/; the 2700 hold
...
constexpr const char* kInputScript =
    ...
    "T=35781864 KEY=SPACE DOWN\n"    // frame 600:  599*59736 (== the evidence
...
int main() {
    ...
    if (actual_sha1 != kScrollShooterSha1) {
        std::cout << "SKIP: scroll-shooter.rom sha1=" << actual_sha1
    ...
    expect(first.scc_attached, "ScrollShooter_SccChipAttachedInBay1");
    ...
    std::cout << "All Machine_Hbf1xvM34ScrollShooterUltrasonic_System cases passed\n";
    return 0;
}
