...
// Suite: Machine_Hbf1xvCommandEngine_Integration
//
// Cross-boundary deterministic coverage of the VDP command engine: drives
// R#32-46 through the
// machine's existing debug_io_write seam, confirms VRAM writes land at the
// expected physical addresses (including a G6 planar
// destination), confirms the S#2 TR/CE status handshake
