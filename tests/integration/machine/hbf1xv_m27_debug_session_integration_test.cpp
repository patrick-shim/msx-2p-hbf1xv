...
// Suite: Machine_Hbf1xvM27DebugSession_Integration (M27-S1, "Production
...
int main() {
    ...
    // assign+attach_image() sequence run_debug_session() uses. ---
    {
        ...
        expect(static_cast<bool>(in), "DiskFlag_RealAssetFileOpens");
    ...
    std::cout << "All Machine_Hbf1xvM27DebugSession_Integration cases passed\n";
    return 0;
}
