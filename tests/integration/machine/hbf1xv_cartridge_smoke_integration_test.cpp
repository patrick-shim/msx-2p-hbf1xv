...
// Suite: Machine_Hbf1xvCartridgeSmoke_Integration
//
...
//
// Unlike the scroll-shooter ROM (genuinely unconfirmable identity),
...
// a concrete, citable source: its SHA1
...
// openMSX 21.0's `share/softwaredb.xml` -- an EXACT hash match to a
...
// fixtures only. This test asserts
...
// hbf1xv_scroll_shooter_smoke_integration_test.cpp's own copy -- each test
...
int main() {
    ...
    //     SlotBus bit layout, slot_bus.cpp) and read back the two
