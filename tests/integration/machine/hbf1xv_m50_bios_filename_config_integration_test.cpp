...
// Suite: Machine_Hbf1xvBiosFilenameConfig_Integration (M50-S3, docs/m50-planner-
// package.md §6-S3, AC-S3-1).
//
...
int main() {
    ...
    const fs::path base = fs::temp_directory_path() / "hbf1xv_m50_s3_bios_filenames";
    std::error_code ec;
