...
// Suite: Machine_Hbf1xvIoParityCheckpoint_Integration
//
// M11-S6: regression-locks THIS emulator's half of the S1985 I/O A/B parity
// harness. The committed probe (tests/parity/bus_probe.bin) is run to its
...
// Byte-identical copy of tests/parity/bus_probe.bin (26 bytes).
