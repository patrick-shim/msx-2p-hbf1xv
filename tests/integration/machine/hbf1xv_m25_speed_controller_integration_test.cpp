...
// Suite: Machine_Hbf1xvM25SpeedController_Integration (M25-S4, backlog C8)
//
// Drives the same deterministic counter-increment loop as
// hbf1xv_m25_pause_integration_test.cpp purely via step_cpu_instruction()
...
int main() {
    ...
    std::cout << "All Machine_Hbf1xvM25SpeedController_Integration cases passed\n";
    return 0;
}
