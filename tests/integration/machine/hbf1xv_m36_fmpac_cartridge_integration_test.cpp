...
// Suite: Machine_Hbf1xvM36FmPacCartridge_Integration (M36-S-d, DEC-0050)
//
...
int main() {
    ...
    expect(fmpac_rom.size() == 16384, "Asset_FmPacRomIs16KB");
    ...
    std::cout << "All Machine_Hbf1xvM36FmPacCartridge_Integration cases passed\n";
    return 0;
}
