...
Usage:
  python tools/convert/mem-to-audio.py <input> -o <out.wav> [--rate HZ] [--bits 8|16] [--channels N]
  python tools/convert/mem-to-audio.py <dump.txt> --region DRAM -o dram.wav
  python tools/convert/mem-to-audio.py --self-check
"""
import argparse
import hashlib
import struct
