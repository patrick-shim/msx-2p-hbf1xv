...
Usage:
  python tools/convert/mem-to-png.py <input> -o <out.png> [--width W] [--pad HEX]
  python tools/convert/mem-to-png.py <dump.txt> --region VRAM -o vram.png
  python tools/convert/mem-to-png.py --self-check
"""
import argparse
import hashlib
import os
