...
# mismatches, or BLOCKED) is written to $DiffOut by tools/analyze/trace-diff.py.
# ---------------------------------------------------------------------------
...
Require-Path -Path $ProgramBin -Label "peripheral-I/O probe (run tools/gen/peripheral-io-probe.py first)"
