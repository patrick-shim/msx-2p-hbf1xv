...
#
# Extends the M16 precedent (tools/openmsx/boot-parity.ps1 Subject 1,
...
& $Emulator --debug-session $BiosDir $BootTraceSteps --stock --disk $Disk --trace-cpu "m28_boot_a.txt" --debug-root $debugRoot
