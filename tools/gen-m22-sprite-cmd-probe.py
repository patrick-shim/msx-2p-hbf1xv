...
on the openMSX side, via tools/openmsx-m22-sprite-cmd-parity.ps1 (raw
...
Usage:
  python tools/gen-m22-sprite-cmd-probe.py [-o tests/parity]
  python tools/gen-m22-sprite-cmd-probe.py --self-check
"""
import argparse
import sys
