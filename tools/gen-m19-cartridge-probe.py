...
Produces TWO deterministic artifacts:
  ...
  2. `tests/parity/m19_cartridge_probe.bin` -- a real Z80 driver program that:
     ...
     trace (tools/trace-diff.py, exactly the M13/M16/M17/M18 mechanism) is
...
tools/openmsx-m19-cartridge-parity.ps1 (which mounts the SAME cartridge file
...
Usage:
  ...
  python tools/gen-m19-cartridge-probe.py --self-check
"""
import argparse
import sys
