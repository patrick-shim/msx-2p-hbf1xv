...
and, on the openMSX side, via tools/openmsx-m21-vdp-render-parity.ps1 (raw
...
Usage:
  python tools/gen-m21-vdp-render-probe.py [-o tests/parity]
  python tools/gen-m21-vdp-render-probe.py --self-check
"""
import argparse
import sys
