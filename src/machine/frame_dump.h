...
//
// Mirrors debug_dump.h's ASCII discipline (fixed field order, fixed-width
// uppercase hex, '\n' line endings, zero wall-clock/environment content) --
// two identical FrameBuffer values produce byte-for-byte identical dump text.
//
// Format:
