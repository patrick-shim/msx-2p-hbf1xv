...
// Reset-status register on I/O port #F4 (added to fix the boot-logo
// cold/warm-boot distinction; a DEC-0026-style targeted defect cycle).
//
...
// openMSX 21.0: src/MSXResetStatusRegister.cc:13-35 (read for
