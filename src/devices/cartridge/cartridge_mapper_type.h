...
// The external-cartridge mapper types: the six base types
// plus KonamiSCC and FmPac.
//
...
// already recognize:
//   openMSX 21.0: src/memory/RomInfo.cc:19-20,23,26-27,92
//     GENERIC_8KB  -> "8kB"
//     GENERIC_16KB -> "16kB"
//     KONAMI       -> "Konami"
//     ASCII8       -> "ASCII8"
...
// std::nullopt for any unrecognized string -- NEVER a silent default
// (only an OMITTED `--cartN-type` flag defaults to Mirrored;
