...
// Deterministic emulated-cycle clock source for the FDC. Mirrors
// rtc::RtcClockSource (src/devices/rtc/rp5c01.h): ALL FDC timing
...
// touched, protecting the CPU/RAM timing oracles.
